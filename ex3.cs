...
public class BankAccount
{
    ...
    public bool ChangePin(string currentPin, string newPin)
    {
        ...
        if (newPin == null)
        {
            Console.WriteLine("Error: New PIN cannot be null.");
            return false;
        }
        ...
        foreach (char c in newPin)
        {
            if (!char.IsDigit(c))
            {
                Console.WriteLine("Error: New PIN must contain only numbers.");
                return false;
            }
        }
...
class Program
{
    static void Main(string[] args)
    {
        ...
        // Direct field access is impossible! (Uncommenting below
